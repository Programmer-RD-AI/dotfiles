...
local harpoonKey = utils.get_harpoon_key()

vim.keymap.set("n", "<leader>ha", function()
	require("harpoon"):list(harpoonKey):add()
end, { desc = "Harpoon add" })
vim.keymap.set("n", "<leader>hh", function()
	local h = require("harpoon")
	h.ui:toggle_quick_menu(h:list(harpoonKey))
end, { desc = "Harpoon menu" })
vim.keymap.set("n", "<leader>h1", function()
	require("harpoon"):list(harpoonKey):select(1)
end, { desc = "Harpoon file 1" })
vim.keymap.set("n", "<leader>h2", function()
	require("harpoon"):list(harpoonKey):select(2)
end, { desc = "Harpoon file 2" })
vim.keymap.set("n", "<leader>h3", function()
	require("harpoon"):list(harpoonKey):select(3)
end, { desc = "Harpoon file 3" })
vim.keymap.set("n", "<leader>h4", function()
	require("harpoon"):list(harpoonKey):select(4)
end, { desc = "Harpoon file 4" })
vim.keymap.set("n", "<leader>hp", function()
	require("harpoon"):list(harpoonKey):prev()
end, { desc = "Harpoon prev" })
vim.keymap.set("n", "<leader>hn", function()
	require("harpoon"):list(harpoonKey):next()
